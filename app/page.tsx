	...
	return (
		<div className="w-full max-w-[750px] mx-auto min-h-screen bg-gray-900 md:border md:border-gray-800">
			...
			<div className="mt-4 flex flex-col items-center text-center justify-center py-10 font-bold">
				...
				<h3 className="text-xl text-gray-400 mt-5 ">
			...
			<div className="px-10">
				<Card className="mt-6 p-7 bg-gray-800 border-amber-950 hover:border-amber-400">
					<CardHeader>
						...
						<CardDescription className="text-center mt-2 text-gray-300 text-md">
							በተጠቀሰው አካውንት ቁጥር ወርሃዊ ክፍያዎትን ከፍለው Screenshot እና
							ስማችሁን እዚህ ላይ ይላኩ፡፡
						</CardDescription>
					</CardHeader>
				...
				<Card className="mt-6 p-7 bg-gray-800 border-amber-950 hover:border-amber-400">
					<CardHeader>
						...
						<CardDescription className="text-center mt-2 text-gray-300 text-md">
							የተለያዩ የበገና ደርዳሪዎችን ዝማሬ እዚህ ጋር ያገኛሉ፡፡ መጋቤ ስብሃት አለሙ
							አጋ፣ አለቃ ተሰማ ፣ ደምሴ ደስታ፤ ዘርፉ ደምሴ እና ሌሎችም...
						</CardDescription>
					</CardHeader>
					<CardContent className="text-center">
      ...
      <div className="border-t mt-10 border-amber-950 bg-gray-800 px-10">
        <p className="text-center text-gray-500 px-10 py-4">2025 የአ/አ/ሳ/ቴ/ዩ የበገና ንዑስ ክፍል. All rights reserved.</p>
